...
# irrelevant:  Vpp_pi_inter

fits = []
for mul in np.linspace(0.8, 1.2, num=6, endpoint=True):
    var_parameters = evo_parameters.copy()
    var_parameters[26] *= 1.  # 0, 4, 7, 13, 16, 17, 19, 20, 29, 30, 31
